  ...
  <div class="dashboard-customer-show">
    ...
    <div class="dashboard-content">
      ...
      <div class="row">
        <div class="col-12">
          <!-- notifikasi -->
          <div class="alert alert-info" v-if="detailOrder.status == 'pending'">
          ...
          <div class="alert alert-info" v-if="detailOrder.status == 'shipping'">
            <p>
              Kami sudah sudah mengirim nomor resi, silahkan lacak pengiriman
              anda
            </p>
          </div>
          <div
